...
const DOCS_META = {
  ...
  license:    { name: 'Licencia',      sub: 'ATPL/CPL',  icon: 'idcard', col: '#3B82F6', authority: 'AESA',          required: true, ratings: true, renewLead: 60 },
  ...
  host.innerHTML =
    ...
    + '<div class="dw-hero-main">'
      + '<div style="display:flex;align-items:center;justify-content:space-between;gap:8px">'
        ...
        + '<button id="docs-sync-btn" class="docs-sync-btn" onclick="event.stopPropagation();docSyncNow()" title="Sincronizar con la nube" aria-label="Sincronizar"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-3-6.7L21 8M21 3v5h-5M3 12a9 9 0 0 0 3 6.7L3 16M3 21v-5h5"/></svg></button>'
      + '</div>'
